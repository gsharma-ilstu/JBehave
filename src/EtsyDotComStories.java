...
public class EtsyDotComStories extends JUnitStories {
    ...
    static {
    	/*FirefoxBinary binary = new FirefoxBinary();  
    	 ...
    	 File("/Applications/Firefox.app/Contents/MacOS/firefoxprofile");
        ...
        return new SeleniumConfiguration()
            ...
            .useStoryReporterBuilder(
                new StoryReporterBuilder()
                    ...
                    .withDefaultFormats()
                    .withFormats(new SeleniumContextOutput(seleniumContext), CONSOLE,HTML,TXT));
    }
    ...
    protected List<String> storyPaths() {
        return new StoryFinder()
                .findPaths(codeLocationFromClass(this.getClass())
                        .getFile(), asList("**/etsy_cart.story"), null);
    }
